...
export function ProductosSaneamiento() {
  ...
  const IMAGEN_DEFECTO = "https://unsplash.com";
...
setBrands(marcasUnicas);
  ...
  // 🚀 LÓGICA DE FILTRADO COMBINADO (Estilo grandes empresas)
        ...
        <div className="col-12 col-md-4 col-lg-3">
          <div className="card border-0 bg-white p-4 rounded-3 shadow-sm position-sticky" style={{ top: "100px" }}>
            ...
            <div className="mb-4">
              ...
              <div className="d-flex justify-between text-muted small mb-2">
            ...
            {filtered.map((p) => (
              <div key={p.idProducto} className="col">
                <div className="card h-100 border-0 shadow-sm rounded-3 overflow-hidden position-relative bg-white border border-gray-100">
                  ...
                  <span className="position-absolute top-0 start-0 m-3 badge bg-white text-secondary border px-2 py-1 shadow-sm text-uppercase fw-semibold" style={{ fontSize: "9px", borderRadius: "4px" }}>
                    {p.categoria || "General"}
                  </span>

                  {/* Caja de Imagen limpia */}
                  <div className="p-4 bg-light d-flex align-items-center justify-content-center" style={{ height: "200px" }}>
                    <img 
                      src={p.imagen ? `http://localhost:8080/${p.imagen}` : IMAGEN_DEFECTO} 
                      alt={p.nombre} 
                  ...
                  <div className="card-body p-4 d-flex flex-column">
                    ...
                    <div className="mt-auto pt-3 border-top border-light d-flex justify-content-between align-items-center">
                      ...
                      {p.color && (
                        <span className="badge bg-light text-muted border-0 small">
                          {p.color}
                        </span>
                      )}
                    </div>
